					...
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							...
							<?php 
								...
								$rowBiodata = mysqli_fetch_assoc($result);
								echo $rowBiodata['header_brief'];
							?>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="info">
						...
						<li><span class="first-block">Phone:</span><span class="second-block"><?php echo $rowBiodata['address_info_phone']; ?></span></li>
						<li><span class="first-block">Email:</span><span class="second-block"> <?php echo $rowBiodata['address_info_email']; ?></span></li>
						<li><span class="first-block">Website:</span><span class="second-block">www.yoursite.com</span></li>
						<li><span class="first-block">Address:</span><span class="second-block"><?php echo '<p>'.$rowBiodata['address_info_address'].'</p>'; ?></span></li>
					</ul>
				</div>
				<div class="col-md-8">
					<?php echo $rowBiodata['about_brief']; ?>
				</div>
			</div>
		</div>
	</div>
						...
						<?php 
							...
							if(mysqli_num_rows($result) > 0){
								...
								while($rowExp = mysqli_fetch_assoc($result)){
									...
									<li class="<?php 
												if($counter == 0) 
													echo 'animate-box timeline-unverted';
												else
													echo 'timeline-inverted animate-box';	
												?>">
										<div class="timeline-badge"><i class="icon-suitcase"></i></div>
										<div class="timeline-panel">
											<div class="timeline-heading">
												<h3 class="timeline-title"><?php echo $rowExp['label']; ?></h3>
												<?php 
													echo '<span class="company">Company Name - '.$rowExp['start'].' - ';
													if($rowExp['end'] == 0){
														echo 'Present</span>';
													} else{
														echo $rowExp['end'].'</span>';
													}		
												?>
											</div>
		...
		<div class="container">
			<div class="services-padding">
				...
				<?php 
					...
					$result = mysqli_query($conn, $sql);
					if(mysqli_num_rows($result) > 0){
						while($rowServices = mysqli_fetch_assoc($result)){
							?>
							<div class="col-md-4 text-center">
								<div class="feature-left">
									<span class="icon">
										<i class="<?php echo $rowServices['icon']; ?>"></i>
									</span>
									<div class="feature-copy">
										<h3><?php echo $rowServices['label']; ?></h3>
										<p><?php echo $rowServices['brief']; ?></p>
									</div>
								</div>
							</div>
							<?php 
		...
		<div class="container">
			...
			<div class="row row-pb-md">
				<?php 
					...
					$result = mysqli_query($conn, $sql);
					if(mysqli_num_rows($result) > 0){
						while($rowSkill = mysqli_fetch_assoc($result)){
							?>
							<div class="col-md-3 col-sm-6 col-xs-12 text-center">
								<?php echo '<div class="chart" data-percent="'.$rowSkill['percentage'].'"><span><strong>'.$rowSkill['label'].'</strong>'.$rowSkill['percentage'].'%</span></div>'; ?>
							</div>
							<?php 
						}
					}
							...
							while($rowSkill = mysqli_fetch_assoc($result)){
								?>
									<div class="progress-wrap">
										<h3><span class="name-left"><?php echo $rowSkill['label']; ?></span><span class="value-right"><?php echo $rowSkill['percentage']; ?>%</span></h3>
										<div class="progress">
										<div class="progress-bar progress-bar-<?php echo $counter; ?> progress-bar-striped active" role="progressbar"
										aria-valuenow="<?php echo $rowSkill['percentage']; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $rowSkill['percentage']; ?>%">
										</div>
										</div>
									</div>
								<?php 
		...
		<div class="container">
			...
			<div class="row">
				<?php 
					...
					$result = mysqli_query($conn, $sql);
					$day = array('st', 'nd', 'rd', 'th');
					$month = array('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec');
					if(mysqli_num_rows($result) > 0){
						while($rowBlogs = mysqli_fetch_assoc($result)){
							?>
							<div class="col-md-4">
								<div class="fh5co-blog animate-box">
									...
									<div class="blog-text">
										<span class="posted_on">
											<?php 
											$date = strtotime($rowBlogs['date']);
											echo date('M. jS Y', $date);
											?>
										</span>
										<h3><a href="#"><?php echo $rowBlogs['blogs']; ?></a></h3>
										<p><?php echo $rowBlogs['content']; ?></p>
										<ul class="stuff">
